    ...
    <body>
        ...
        <script>
            function confirmarEliminacion(idCita) {
                ...
                if (confirmacion) {
                    // Si el usuario hace clic en "Aceptar", redirigir al servlet para eliminar la cita
                    window.location.href = "CrudServicio?accion=Eliminar&id=" + idCita;
                    alert("Se ha eliminado el servicio correctamente.");
                    return true;
                } else {
                    // Si el usuario hace clic en "Cancelar", cancelar la acción de eliminación
                    return false;
                }
            }
        </script>
