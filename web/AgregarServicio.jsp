...
<html lang="en">
        ...
        <main>
            ...
            <section class="hero-section">
                <div class="container mt-5">
                    <form action="RegistrarServicio" method="post" onsubmit="return confirmacionRegistro()">
    ...
    <script>
        function confirmacionRegistro() {
            var confirmacion = confirm("¿Estás seguro de que deseas registrar un nuevo servicio?");
            if (confirmacion) {
                alert("Se ha registrado un nuevo servicio correctamente.");
                return true;
            } else {
                alert("El registro de nuevo servicio ha sido cancelado.");
                return false;
            }
        }
    </script>
